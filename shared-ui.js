...
const translations = {
  en: {
    ...
    card010Desc:          'The portfolio site I built for my PROG-102: Code class at Columbia College Chicago — a sidebar profile paired with a project carousel showcasing coursework like the Random Number Generator, built with HTML, CSS, and JavaScript.',
    card011Desc:          'A browser-based roulette simulation built with plain HTML, CSS, and vanilla JavaScript. Spin the wheel, watch the ball land on a number, and follow along on a red-black-green betting table like a real casino.',
  ...
  es: {
    ...
    card010Desc:          'El sitio de portafolio que construí para mi clase PROG-102: Code en Columbia College Chicago — un perfil lateral junto a un carrusel de proyectos que muestra trabajos del curso como el Generador de Números Aleatorios, hecho con HTML, CSS y JavaScript.',
    card011Desc:          'Una simulación de ruleta construida con HTML, CSS y JavaScript puro. Gira la rueda, observa dónde cae la bola y sigue el resultado en una mesa de apuestas roja, negra y verde como en un casino real.',
