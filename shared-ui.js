...
const translations = {
  en: {
    ...
    gallery4Title:        'Backyard Fire',
    gallery4Desc:         'Late-night fire pit with friends — the kind of night that turns into a good story.',
    ...
    gallery9Title:        'Ukiyo-e Clash',
    gallery9Desc:         'A woodblock-style print of a snow leopard and black panther locked in battle on a deep blue background.',
    gallery10Title:       'Gym Days',
    gallery10Desc:        'Mirror selfie at the weight room — staying consistent.',
    gallery11Title:       'Caught on Camera',
    gallery11Desc:        'The CTA security feed caught us on the Brown Line — smiling for the screen.',
    ...
    gallery13Title:       'On the Clock',
    gallery13Desc:        'Working the floor at Xfinity — iPad boxes stacked and ready to go.',
    gallery14Title:       'Comcast Days',
    gallery14Desc:        'On site at Comcast — the first chapter of a career in telecom.',
  ...
  es: {
    ...
    gallery4Title:        'Fogata en el Patio',
    gallery4Desc:         'Fogata de madrugada con amigos — el tipo de noche que se convierte en buena historia.',
    ...
    gallery9Title:        'Choque Ukiyo-e',
    gallery9Desc:         'Una impresión estilo grabado en madera de un leopardo de las nieves y una pantera negra en batalla sobre fondo azul.',
    gallery10Title:       'Días de Gym',
    gallery10Desc:        'Selfie en el espejo del gimnasio — manteniéndose constante.',
    gallery11Title:       'Capturado en Cámara',
    gallery11Desc:        'La cámara de seguridad del CTA nos capturó sonriendo en la Línea Café.',
    ...
    gallery13Title:       'En el Turno',
    gallery13Desc:        'Trabajando en Xfinity — cajas de iPad apiladas y listas para ir.',
    gallery14Title:       'Días en Comcast',
    gallery14Desc:        'En el sitio de Comcast — el primer capítulo de una carrera en telecomunicaciones.',
